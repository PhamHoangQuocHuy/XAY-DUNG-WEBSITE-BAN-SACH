    ...
    <div class="table-agile-info">
        <div class="panel panel-default">
            ...
            <div class="table-responsive">
                ...
                ?>
                <form action="{{ URL::to('/delete-selected-suppliers') }}" method="POST" id="delete-form">
                    {{ csrf_field() }}
                    <table class="table table-striped b-t b-light">
                        ...
                        <tbody>
                            ...
                            @foreach ($all_supplier as $key => $sup)
                                <tr>
                                    <td style="text-align: center;align-content: center"><label
                                            class="i-checks m-b-none"><input type="checkbox" name="suppliers[]"
                                                value="{{ $sup->supplier_id }}"><i></i></label></td>
                    ...
                    <!-- Nút Xóa tất cả đã chọn -->
                    <button type="submit" class="btn btn-danger"
                        onclick="return confirm('Bạn có chắc muốn xóa các nhà cung cấp đã chọn?')">Xóa tất cả đã chọn</button>
                </form>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-7 text-right text-center-xs">
                        <div class="col-sm-7 text-right text-center-xs">
                            ...
                            @if ($all_supplier instanceof \Illuminate\Pagination\LengthAwarePaginator) {{ $all_supplier->links() }}
                            @endif
                        </div>
                    </div>
                </div>
