                    ...
                    <tbody>
                        @foreach ($all_author as $key => $author)
                            <tr>
                                ...
                                <td style="text-align: center;align-content: center; color: black">{{ $author->author_name }}</td>
                                <td style="text-align: center; align-content: center;">
                                    <a href="{{ URL::to('edit-author/' . $author->author_id) }}" class="active" ui-toggle-class="">
