...
@section('content')
                ...
                <div id="similar-product" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            @foreach ($relate_home as $key => $lienquan_home)
                                <a href="{{ URL::to('/chi-tiet-san-pham-theo-nxb/' . $lienquan_home->book_id) }}">
                                    <div class="col-sm-4">
            ...
            <div class="col-sm-7">
                <div class="product-information"><!--/product-information-->
                    ...
                    <form action="{{ URL::to('/save-cart') }}" method="POST">
                        ...
                        <span>
                            <span>{{ $value_home->formatted_price = number_format($value_home->price, 0, ',', '.') }}
                                VNĐ</span>
                    ...
                    <p><b>Thể loại:</b> {{ $value_home->category_name }}</p>
                    <p><b>Tác giả:</b> {{ $value_home->author_name }}</p>
        ...
        <div class="category-tab shop-details-tab"><!--category-tab-->
            <div class="col-sm-12">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#reviews" data-toggle="tab" data-book-id="{{ $value_home->book_id }}">XEM ĐÁNH GIÁ/ BÌNH
                            LUẬN</a></li>
                </ul>
            </div>
            <div class="tab-content">
                <div class="tab-pane fade  active in" id="details">
                    <h1 style="color: #FE980F;text-align: center">MÔ TẢ {{ $value_home->book_name }}</h1>
                    <p><strong>{!! $value_home->description !!}</strong></p>
                </div>
                ...
                <div class="tab-pane fade" id="reviews">
                    <div class="col-sm-12">
                        ...
                        if ($user_id != NULL) {
                        ?>
                        <form action="{{ URL::to('/save-review/' . $value_home->book_id) }}" method="POST">
                            {{ csrf_field() }}
    ...
    <div class="recommended_items"><!--recommended_items-->
        <h2 class="title text-center" style="padding-top: 10px">SẢN PHẨM LIÊN QUAN</h2>
        @if ($relate_home->isNotEmpty())
