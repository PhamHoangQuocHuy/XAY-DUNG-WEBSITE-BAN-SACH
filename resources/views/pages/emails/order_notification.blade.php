            ...
            <div class="row" style="background: #ff66cc;padding: 15px">
                ...
                <div class="col-md-6" style="text-align: center;color: #fff;font-weight: bold;font-size: 30px">
                    <h4 style="margin: 0">WEBSITE BÁN SÁCH <a href="http://localhost/xaydungwebsitebansach/">
                            BOOK.VN</a></h4>
                    <h6 style="margin: 0">EMAIL ĐÃ NHẬN ĐƯỢC THÔNG TIN ĐƠN HÀNG VỪA ĐẶT</h6>
                </div>

                <div class="col-md-6 logo" style="color: #fff">
                    <p>Chào bạn <strong style="color: #000; text-decoration: underline;">{{ $name }}</strong>
                        , chúng tôi đã nhận được thông tin đơn hàng của bạn đặt ở website của chúng tôi với thông tin
                        đơn hàng như sau:
                    </p>
                </div>
                <div class="col-md-12">
                    ...
                    <p>Mã khuyến mãi áp dụng: <strong style="text-transform: uppercase;color: #fff">Không có</strong>
                    </p>
