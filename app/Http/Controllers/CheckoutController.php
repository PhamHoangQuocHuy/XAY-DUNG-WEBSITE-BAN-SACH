...
{ 
    ...
    public function order_place(Request $request)
    {
        ...
        // Lấy user_id và shipping_id từ session
        $user_id = Session::get('user_id');
        $shipping_id = Session::get('shipping_id');

        // Kiểm tra nếu user_id và shipping_id là hợp lệ
        ...
        // INSERT ORDER
        $order_data = array();
        $order_data['user_id'] = $user_id; // lấy session user đang đăng nhập
        ...
        $order_data['order_total'] = str_replace(',', '', Cart::subtotal()); // Loại bỏ dấu phẩy
        ...
        foreach ($content as $value) {
            ...
            $order_details_data['order_details_quantity'] = $value->qty; // lấy từ trường qty package
